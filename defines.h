...
#define VREF                        1.25    // Tensão de saída da Ponte de Wheatstone (V)
#define VEXC                        2.5     // Tensão de excitação da Ponte de Wheatstone (V)
#define R0GAUGE                     350.0   // Resistência nominal da strain gauge (?)
#define GF                          2.0     // Gauge Factor da strain gauge
#define E                           200e9   // Módulo de Young do material (ex: aço = 200 GPa)
#define AREA                        0.0001  // Área da seção transversal em m² (exemplo: 10mm x 10mm)
...
#define TEMP_CH                     0       // CANAL - SENSOR ANALÓGICO DE TEMPERATURA NTC
#define SBAT_CH                     1       // CANAL - SENSOR ANALÓGICO DA BATERIA 
#define SGZ_CH                      13      // CANAL - SENSOR ANALÓGICO STRAIN GAUGE X
#define SGY_CH                      14      // CANAL - SENSOR ANALÓGICO STRAIN GAUGE Y
#define SGX_CH                      15      // CANAL - SENSOR ANALÓGICO STRAIN GAUGE Z
